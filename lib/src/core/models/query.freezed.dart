...
abstract mixin class $QueryCopyWith<TData, TError extends Exception, $Res> {
  factory $QueryCopyWith(Query<TData, TError> value,
      $Res Function(Query<TData, TError>) _then) = _$QueryCopyWithImpl;
  @useResult
  $Res call(
      {QueryKey key,
      TData? data,
...
extension QueryPatterns<TData, TError extends Exception>
    on Query<TData, TError> {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_Query<TData, TError> value)? $default, {
...
class _Query<TData, TError extends Exception> extends Query<TData, TError>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$QueryCopyWith<TData, TError, _Query<TData, TError>> get copyWith =>
      __$QueryCopyWithImpl<TData, TError, _Query<TData, TError>>(
          this, _$identity);
...
/// @nodoc
abstract mixin class _$QueryCopyWith<TData, TError extends Exception, $Res>
    implements $QueryCopyWith<TData, TError, $Res> {
  factory _$QueryCopyWith(_Query<TData, TError> value,
      $Res Function(_Query<TData, TError>) _then) = __$QueryCopyWithImpl;
  @override
  @useResult
  $Res call(
      {QueryKey key,
